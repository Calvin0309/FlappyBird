def on_a_pressed():
    animation.run_image_animation(mySprite, jump, 10, True)
    mySprite.vy = -100
...
def on_on_overlap(sprite, otherSprite):
    ...
    game.splash("Score: ", String.from_char_code(info.score()))
...
def on_update_interval():
    global gap, top, bottom, projectile
    gap = randint(1, 3)
    if gap == 1:
        top = img("""
            .....6eeeeeeeeeece6.....
        ...
        bottom = img("""
            ........................
                        ...
                        ......ee6eeeeee6eef.....
        """)
    projectile = sprites.create_projectile_from_side(top, -50, 0)
    projectile.top = 0
    projectile = sprites.create_projectile_from_side(bottom, -50, 0)
